								...
								<div class="card-body">
									<div class="row">
											...
											<div class="col-md-6 col-lg-6">		
												...
												<div class="form-group">
													<label>Scan Surat Pengantar</label>
													<input type="file" name="sk" class="form-control" size="37" required>
												</div>
											</div>
									</div>
								</div>
...
if(isset($_POST['kirim'])){
	...
	$keperluan = $_POST['keperluan'];
		...
		$nama_sk = isset($_FILES['sk']);
    	$file_sk = $_POST['nik']."_".".jpg";
	$sql = "INSERT INTO data_request_sktm (nik,scan_ktp,scan_kk,scan_sk,keperluan) VALUES ('$nik','$file_ktp','$file_kk', '$file_sk','$keperluan')";
	...
	if($query){
		...
		copy($_FILES['sk']['tmp_name'],"../dataFoto/scan_sk/".$file_sk);
