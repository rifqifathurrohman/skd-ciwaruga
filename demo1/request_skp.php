								...
								<div class="card-body">
									<div class="row">
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													<label>Lama</label>
													<input type="number" name="lama" class="form-control" placeholder="Ijin berapa hari.." autofocus>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" name="instansi" class="form-control" placeholder="Instansi Anda.." autofocus>
												</div>
											</div>
											<div class="col-md-6 col-lg-6">		
												<div class="form-group">
												...
												<div class="form-group">
													<label>Scan Surat Keterangan</label>
